      ...
      <div class="container-xl">
        <div class="row">
          <div class="col-xl-12 col-sm-12 col-12">
            <h1 class="pt-3 text-center">Terms Of Service</h1>
          </div>
        </div>
      </div>
    </header>
    <div className="divider-top container-xl text-light pb-5">
      <div className="m-auto">
        <h2>Agreement</h2>
        <p>
          By signing up to be an Affiliate in the NightSmurf Affiliate Program
          (&ldquo;Program&rdquo;) you are agreeing to be bound by the following
          terms and conditions (&ldquo;Terms of Service&rdquo;).
        </p>
        <p>
          NightSmurf&nbsp;reserves the right to update and change the Terms of
          Service from time to time without notice. Any new features that
          augment or enhance the current Program, including the release of new
        ...
        <p>
          ...
          your Account and for forfeiture of any outstanding affiliate
          commission payments earned during the violation. You agree to use the
          Affiliate Program at your own risk.
        </p>
        <h2>Account Terms</h2>
        <ul>
          ...
          <li>
            Your login may only be used by one person &ndash; a single login
            shared by multiple people is not permitted.
          </li>
          <li>
            You are responsible for maintaining the security of your account and
            password.&nbsp;NightSmurf&nbsp;cannot and will not be liable for any
          ...
          <li>
            You may not use the Affiliate Program to earn money on your
            own&nbsp;NightSmurf&nbsp;product accounts.
          </li>
        </ul>
        <h2>
        ...
        <p>
          ...
          to&nbsp;NightSmurf. We may change the design of the artwork at any
          time without notice, but we won&rsquo;t change the dimensions of the
        ...
        <p>
          ...
          between your site and the&nbsp;NightSmurf. You must ensure that each
          of the links between your site and the&nbsp;NightSmurf&nbsp;properly
          utilizes such special link formats. Links to
          the&nbsp;NightSmurf&nbsp;placed on your site pursuant to this
          Agreement and which properly utilize such special link formats are
          referred to as &ldquo;Special Links.&rdquo; You will earn referral
          fees only with respect to sales on a&nbsp;NightSmurf&nbsp;product
          occurring directly through Special Links; we will not be liable to you
          with respect to any failure by you or someone you refer to use Special
          Links or incorrectly type your Affiliate Code, including to the extent
          that such failure may result in any reduction of amounts that would
          otherwise be paid to you pursuant to this Agreement.
        </p>
        <p>
          Affiliate links should point to the page of the product being
          promoted.
        </p>
        <h2>Referral fees/commissions and payment</h2>
        <p>
          For a Product sale to be eligible to earn a referral fee, the customer
          must click-through a Special Link from your site, email, or other
          communications to&nbsp;https://nightsmurf.com&nbsp;and complete an
          order for a product during that session.
        </p>
        <p>
          We will only pay commissions on links that are automatically tracked
          and reported by our systems. We will not pay commissions if someone
          says they purchased or someone says they entered a referral code if it
          was not tracked by our system. We can only pay commissions on business
          generated through properly formatted special links that were
        ...
        <p>
          Payments only begin once you&rsquo;ve earned more
          than&nbsp;$20&nbsp;in affiliate income. If your affiliate account
          never crosses the&nbsp;$20&nbsp;threshold, your commissions will not
          be realized or paid. We are only responsible for paying accounts that
          have crossed the&nbsp;$20&nbsp;threshold.
        </p>
        <h2>Identifying yourself as a NightSmurf Affiliate</h2>
        <p>
          ...
          develop our products, say you are part of&nbsp;NightSmurf&nbsp;or
        ...
        <p>
          As long as your current affiliate earning are over&nbsp;$20,
          you&rsquo;ll be paid each month. If you haven&rsquo;t
          earned&nbsp;$20&nbsp;since your last payment, we&rsquo;ll pay you the
          following month after you&rsquo;ve crossed the threshold.
        </p>
        ...
        <p>
          &ndash; The technical operation of your site and all related equipment
          <br />
          &ndash; Ensuring the display of Special Links on your site does not
          violate any agreement between you and any third party (including
          without limitation any restrictions or requirements placed on you by a
          third party that hosts your site)
          <br />
          &ndash; The accuracy, truth, and appropriateness of materials posted
          ...
          Special Links)
          <br />
          &ndash; Ensuring that materials posted on your site do not violate or
          ...
          rights)
          <br />
          &ndash; Ensuring that materials posted on your site are not libelous
          or otherwise illegal
          <br />
          &ndash; Ensuring that your site accurately and adequately discloses,
          either through a privacy policy or otherwise, how you collect, use,
          store, and disclose data collected from visitors, including, where
          ...
          visitors and may place or recognize cookies on visitors&rsquo;
          browsers.
        </p>
        ...
        <p>
          ...
          condition of your participation in the Program you will comply with
          all applicable laws (federal, state or otherwise) that govern
          marketing email, including without limitation, the CAN-SPAM Act of
          2003 and all other anti-spam laws.
        </p>
        ...
        <p>
          ...
          links to&nbsp;https://nightsmurf.com, and all of our trademarks, trade
          dress, and logos, and all other materials provided by or on behalf of
          us to you pursuant hereto or in connection with the
          Program.&nbsp;NightSmurf&nbsp;reserves the right to end the Program at
          any time. Upon program termination,&nbsp;NightSmurf&nbsp;will pay any
          outstanding earnings accrued above&nbsp;$20.
        </p>
        <h2>Termination</h2>
        <p>
          NightSmurf, in its sole discretion, has the right to suspend or
          terminate your account and refuse any and all current or future use of
          the Program, or any other&nbsp;NightSmurf&nbsp;service, for any reason
          ...
          Account, and the forfeiture and relinquishment of all potential or
          to-be-paid commissions in your Account if they were earned through
          fraudulent, illegal, or overly aggressive, questionable sales or
          marketing methods.&nbsp;NightSmurf&nbsp;reserves the right to refuse
        ...
        <p>
          ...
          the&nbsp;NightSmurf&nbsp;will be uninterrupted or error-free, and we
        ...
        <p>
          ...
          Arbitration Association. The arbitrator&rsquo;s award shall be binding
        ...
        <p>
          ...
          without reference to rules governing choice of laws. You may not
        ...
        <p>
          The failure of&nbsp;NightSmurf&nbsp;to exercise or enforce any right
          ...
          agreement between you and&nbsp;NightSmurf&nbsp;and govern your use of
          the Service, superceding any prior agreements between you
          and&nbsp;NightSmurf&nbsp;(including, but not limited to, any prior
