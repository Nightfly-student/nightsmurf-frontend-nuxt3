...
const MmrRegionEmits = defineEmits(["region"]);
const onMmrRegionClick = (value) => {
    region.value = value;
    MmrRegionEmits("region", region.value);
}
</script>
  ...
  <div>
    <ul class="nav justify-content-center">
      <li class="nav-item">
        <a
          type="button"
          :class="{ active: region === 'euw' }"
          class="nav-link"
          @click="onMmrRegionClick('euw')"
        >
          <svg
            version="1.0"
...
-7 -41 20 -38 29 10 29 31 0 36 -3 36 -22z"
      ...
      <li class="nav-item">
        <a
          type="button"
          :class="{ active: region === 'eune' }"
          class="nav-link"
          @click="onMmrRegionClick('eune')"
        >
          <svg
            version="1.0"
            xmlns="http://www.w3.org/2000/svg"
...
-5 -5 -11 -11 -13 -6 -2 -11 4 -11 13 0 9 5 15 11 13 6 -2 11 -8 11 -13z"
      ...
      <li class="nav-item">
        <a
          type="button"
          :class="{ active: region === 'na' }"
          class="nav-link"
          @click="onMmrRegionClick('na')"
        >
          <svg
            version="1.0"
            xmlns="http://www.w3.org/2000/svg"
