...
<template>
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark">
    <div class="container-xl">
      <NuxtLink to="/" class="navbar-brand">Nightsmurf</NuxtLink>
      <button
        type="button"
                  ...
                  <li>
                    ...
                    >
                      <svg
                        ...
                        width="20px"
                        height="20px"
                        viewBox="0 0 110.000000 49.000000"
                        fill="white"
                        preserveAspectRatio="xMidYMid meet"
                      >
                        <g
                  ...
                  <li>
                    ...
                    >
                      <svg
                        ...
                        width="20px"
                        height="20px"
                        viewBox="0 0 85.000000 89.000000"
                        fill="white"
                        preserveAspectRatio="xMidYMid meet"
                      >
                        <g
                        ...
                        >
                          <path
                            d="M248 873 c-22 -3 -43 -12 -51 -23 -7 -10 -30 -21 -52 -24 -58 -10
                  ...
                  <li>
                    ...
                    >
                      <svg
                        ...
                        width="20px"
                        height="20px"
                        viewBox="0 0 42.000000 103.000000"
                        fill="white"
                        preserveAspectRatio="xMidYMid meet"
                      >
                        <g
                        ...
                        >
                          <path
                            d="M78 995 c-36 -25 -37 -25 -31 -80 3 -32 1 -60 -5 -67 -6 -8 -11 -77
...
-32 7 -47 22 -38 37 3 4 10 2 16 -6 7 -8 21 -20 32 -26z"
                          ></path>
                        </g></svg
                      >LAS Accounts</NuxtLink
                    >
                  </li>
                  <li>
                    <NuxtLink
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <path
                            d="M19 954 c-10 -13 -10 -23 0 -57 7 -23 15 -55 18 -70 3 -16 12 -31 19
                  ...
                  <li>
                    ...
                    >
                      <svg
                        ...
                        width="20px"
                        height="20px"
                        viewBox="0 0 108.000000 71.000000"
                        fill="white"
                        preserveAspectRatio="xMidYMid meet"
                      >
                        <g
                        ...
                        >
                          <path
                            d="M285 691 c-3 -6 -19 -16 -35 -24 -25 -13 -31 -13 -41 -1 -19 23 -58
...
m38 -75 c-3 -3 -9 2 -12 12 -6 14 -5 15 5 6 7 -7 10 -15 7 -18z"
                          ></path>
                        </g></svg
                      >RU Accounts</NuxtLink
                    >
                  </li>
                  <li>
                    <NuxtLink class="dropdown-item" to="/lol-skin-accounts"
                      ><BIconGlobe class="me-1" /> Skin Accounts</NuxtLink
                    >
                  </li>
                </ul>
              </li>
          ...
          <NuxtLink class="nav-item nav-link" to="/lol-skin-accounts"
            >LoL Skin Accounts</NuxtLink
          >
          <NuxtLink class="nav-item nav-link" to="/free-lol-account"
            >Free LoL Account</NuxtLink
          >
          <NuxtLink class="nav-item nav-link" to="/loyalty"
            >Loyalty Program</NuxtLink
          >
          <NuxtLink class="nav-item nav-link" to="/mmr-checker"
            >MMR Checker</NuxtLink
          >
          <NuxtLink class="nav-item nav-link" to="/affiliate"
            >Affiliate</NuxtLink
          >
        ...
        <div class="navbar-nav ms-auto" v-if="mounted">
          ...
          <div v-else class="dropdown">
            ...
            >
              <li v-if="store.getIsAdmin || store.getIsMod">
                <NuxtLink class="dropdown-item" to="/admin/dashboard"
                  >Dashboard</NuxtLink
                >
              </li>
              <li v-if="store.getIsAffiliate">
                <NuxtLink class="dropdown-item" to="/affiliate/dashboard"
                  >Affiliate Dashboard</NuxtLink
                >
              </li>
              <li>
                <NuxtLink class="dropdown-item" to="/user/order-history"
                  >Order History</NuxtLink
                >
              </li>
              <li>
                <NuxtLink class="dropdown-item" to="/user/settings"
                  >Settings</NuxtLink
                >
              </li>
              <li>
